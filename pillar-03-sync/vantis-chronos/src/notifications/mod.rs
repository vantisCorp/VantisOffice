...
impl ReminderManager {
    ...
    pub fn schedule_reminder(&mut self, event_id: &str, event_start: DateTime<Utc>, minutes_before: u32) -> Reminder {
...
impl ConflictAlertManager {
    ...
    pub fn create_alert(&mut self, event1_id: &str, event2_id: &str, severity: ConflictSeverity) -> ConflictAlert {
