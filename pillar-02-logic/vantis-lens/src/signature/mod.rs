...
impl SignatureManager {
    ...
    pub fn create_signature(&self, document_id: String, signer_name: String, signer_email: String) -> Result<DigitalSignature, String> {
        if !self.enabled {
    ...
    pub fn verify_signature(&self, signature_id: &str) -> Result<SignatureStatus, String> {
        ...
        let signature = signatures.get(signature_id)
    ...
    fn verify_signature_internal(&self, signature: &DigitalSignature) -> Result<SignatureStatus, String> {
    ...
    pub fn revoke_signature(&self, signature_id: &str, reason: String) -> Result<(), String> {
        ...
        let signature = signatures.get_mut(signature_id)
            .ok_or_else(|| format!("Signature '{}' not found", signature_id))?;
...
impl DigitalSignature {
    ...
    pub fn with_location(mut self, page_index: usize, x: f64, y: f64, width: f64, height: f64) -> Self {
